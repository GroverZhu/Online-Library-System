			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="tables.jsp" class="active"><i class="lnr lnr-dice"></i> <span>Reader Index</span></a></li>
						<li><a href="typography.jsp" class=""><i class="lnr lnr-text-format"></i> <span>Fine</span></a></li>
						<li><a href="icons.jsp" class=""><i class="lnr lnr-linearicons"></i> <span>Reaserve</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
					...
					<div class="row">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Reader Index</h3>
								</div>
