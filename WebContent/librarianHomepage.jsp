							...
							<div class="row">
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											<span class="number">todayIncome</span> <span class="title">Today</span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
									<div class="metric">
										<span class="icon"><i class="fa fa-download"></i></span>
										<p>
											<span class="number">weekIncome</span> <span class="title">This
												Week</span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
									<div class="metric">
										<span class="icon"><i class="fa fa-download"></i></span>
										<p>
											<span class="number">monthIncome</span> <span class="title">This
												Month</span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
									<div class="metric">
										<span class="icon"><i class="fa fa-download"></i></span>
										<p>
											<span class="number">yearIncome</span> <span class="title">This
												Year</span>
										</p>
									</div>
								</div>
