...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<li><a href="librarianHomepage.jsp"><img src="assets/img/BiblioSoft Logo.png" alt="BiblioSoft Logo" class="img-responsive logo"></a>
			</div>
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="assets/img/user.png"
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="#subPages1" data-toggle="collapse" class=""><i class="lnr lnr-cog"></i> <span>Books Management</span>
						...
						<li><a href="#subPages2" data-toggle="collapse" class="collapsed"><i class="lnr lnr-cog"></i> <span>Readers
						...
						<li><a href="#subPages3" data-toggle="collapse" class="active"><i class="lnr lnr-cog"></i> <span>Posts Management</span>
								<i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages3" class="collapse in">
								<ul class="nav">
									<li><a href="addPost.jsp" class="">Add Post</a></li>
									<li><a method="post" href="AllPost" class="active">Search
											Post</a></li>
								</ul>
							</div>
						</li>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Post search</h3>
					<div class="row">
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Input the post title</h3>
								</div>
								<div class="panel-body">
									<div class="col-md-12">
										<form method="post" action="SearchPostByTitle">
											<div class="input-group" style="width: 600px;">
												<input class="form-control" id="thetitle" name="thetitle" type="text"> <span class="input-group-btn"><button
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 style="font-size: 21px;" panel-title">Posts</h3>
								</div>
								<div class=" panel-headline">

									<c:forEach var="post" items="${sessionScope.posts}" varStatus="infoLoopCount">
										<div class="panel-heading">
											<h3>
												<a style="font-size: 16px;" href="DisplayThePost?title=${post.title}">${post.title}</a>
											</h3>
											<p>${post.body}</p>
										</div>
									</c:forEach>
				...
				<footer>
					<div class="container-fluid">
						<p class="copyright">
							Copyright &copy; 2018.Company name All rights reserved. <a target="_blank" title="BiblioSoft">BiblioSoft</a> -
							Collect from
							<a title="BiblioSoft" target="_blank">Software</a>
						</p>
