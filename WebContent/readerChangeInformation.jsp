									...
									<table class="table">
										...
										<tbody>
									      ...
									      <form method="post" action="ReaderModifyInformation">
												<td><input type="text" name="newName" maxlength="15" style="height:23px;width:100px"></td>
												<td><input type="text" name="newPassword" maxlength="15" style="height:23px;width:100px"></td>
												<td><input type="text" name="newEmail" maxlength="15" style="height:23px;width:100px"></td>														
											</tr>									
											<tr>
