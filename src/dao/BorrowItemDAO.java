...
public class BorrowItemDAO {
	...
	public List<BorrowItem> getBorrowItemInCurrent(int start,int count,int readerId){
		...
		try {
			...
			System.out.println("--BorrowItemDAO--,--getBorrowItemInCurrent(int start,int count,int readerId)--,suffers exception");
			return null;
		}
	...
	public List<BorrowItem> getBorrowItemInHistory(int start,int count,int readerId){
		...
		try {
			...
			System.out.println("--BorrowItemDAO--,--getBorrowItemInHistory(int start,int count,int readerId)--,suffers exception");
			return null;
		}
	...
	public List<BorrowItem> getBorrowItemInReturn(int start,int count,int readerId){
		...
		try {
			...
			System.out.println("--BorrowItemDAO--,--getBorrowItemInReturn(int start,int count,int readerId)--,suffers exception");
			return null;
		}
	}
	/**
