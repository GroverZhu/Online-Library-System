 ...
 *@author zengyaoNPU
 */
public class ChangeReaderInformation extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ChangeReaderInformation() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("--ChangeReaderInformation--doGet()");
		...
		RequestDispatcher dispatcher=request.getRequestDispatcher("../../ChangeReaderInformation.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("--ChangeReaderInformation--doPost()");
		...
		if(readerDAO.updateData(id, name, password, email,state)) {
			response.sendRedirect("OperateReader?reader_id="+id);//转发到该页面
		}else {
